!!!!IMPORTANT!!!!
I provide the data base in SQL script in SQL-Database folder.
Connection string must be corrected in the application as well.
!!!!!!!!!!!!!!!!!

1. The quality of the code is fairly low for my standarts, but the code works quite nicely.
